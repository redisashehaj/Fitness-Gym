...
<?php 
	...
	$id = $row[ 'perdorues_id' ] + 1; /// +1 pasi ky do te jete vendi real i Instruktorit te ri ne db.
  ...
  $id += 2000000;
	...
	///Krijimi i sesionit
	$_SESSION[ 'kod_regjistrimi_instruktori' ] = $hash;
 ?>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="http://localhost:1234/palestra/admin/includes/kodInstruktori.php"><i class="glyphicon glyphicon-tower"></i> Shto Instruktor</a></li>
          </ul>
...
<!-- Permbajtja Dashboard -->
  	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
     		<h1 class="page-header text-center">Kodi i Instruktorit te ri</h1>
            ...
            <div class="col-xs-12 col-sm-8 placeholder">
				...
				<h2>Kodi i perdoruesit <?= $id - 2000000; ?>: <strong><?= $hash ?></strong></h2>
            </div>
